...
export interface Session {
  // Step tracking for multi-step flows
  step?: "idle" | "awaiting_ticker" | "awaiting_alert_config" | "awaiting_quiet_hours" | "awaiting_summary_time";
  
  // Temporary flow data (cleared after flow completes)
